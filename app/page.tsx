...
export default function Home() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // If promo code is TEST2024, redirect directly to test-success page
      if (formData.promoCode.toUpperCase() === 'TEST2024') {
        // Bypass payment for testing
        window.location.href = '/test-success';
        return;
      }
      
      // Otherwise, go to payment page with form data
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          {showPromoCode && (
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              />
              {formData.promoCode.toUpperCase() === 'TEST2024' && (
